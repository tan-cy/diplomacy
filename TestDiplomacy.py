...
class TestDiplomacy(TestCase):
    ...
    def test_attacked_1(self):
        ...
        current = {'A': 'Austin', 'B': 'Madrid',
                   'C': 'Houston', 'D': 'NewYork', 'E': 'Detroit'}
        answer = diplomacy_attacked(attackers, current)
        self.assertEqual(answer, {'B': ['A', 'C'], 'C': ['E']})

    def test_attacked_2(self):
        attackers = {'A': 'Madrid', 'C': 'Madrid', 'D': 'Madrid',
                     'E': 'Houston', 'G': 'Houston', 'H': 'NewYork'}
        current = {'A': 'Austin', 'B': 'Madrid', 'C': 'Cairo', 'D': 'Houston',
                   'E': 'Tomball', 'F': 'NewYork', 'G': 'LaPaz', 'H': 'Tarija'}
        answer = diplomacy_attacked(attackers, current)
        self.assertEqual(
            answer, {'B': ['A', 'C', 'D'], 'D': ['E', 'G'], 'F': ['H']})
    ...
    def test_compare_2(self):
        ...
        current = {'A': 'Austin', 'B': 'Berlin',
                   'C': 'Cairo', 'D': 'Detroit', 'E': 'NewYork'}
        answer = diplomacy_compare(
            attacked, attackers, army, opp_army, supported, supporters, current)
        self.assertEqual(answer, ({'A': 2, 'B': 1}, {'C': 'A', 'D': 'A', 'E': 'B'}, {
                         'A': 'Austin', 'B': '[dead]', 'C': 'Cairo', 'D': 'Detroit', 'E': 'NewYork'}))
    ...
    def test_compare_3(self):
        ...
        answer = diplomacy_compare(
            attacked, attackers, army, opp_army, supported, supporters, current)
        self.assertEqual(answer, ({'A': 0, 'D': 0}, {}, {
                         'A': '[dead]', 'B': 'Berlin', 'C': 'Cairo', 'D': '[dead]'}))
